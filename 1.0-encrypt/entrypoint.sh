...
cd /tmp
tar --extract -vv --occurrence --file=./tmp/$SW_VERSION.tar $SW_VERSION.encrypt
...
cd /tmp
tar --extract -vv --occurrence --file=./tmp/$SW_VERSION.tar $SW_VERSION.jar -C /opt/clientesapp
