...
#UNTAR THE ENCRYPT SW_VERSION, COPY ENCRYPT FILE TO TMP, DECRYPT TO TAR WITH OPENSSL DECRYPT-SCRIPT AND DELETE TEMPORAL FOLDER
...
#UNTAR FILES OF SW_VERSION TO JAR, COPY JAR IN APP FOLDER AND DELETE ALL TEMP FILES
